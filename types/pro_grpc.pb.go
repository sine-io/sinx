// protoc -I api/proto/ --go_out=proto --go_opt=paths=source_relative --go-grpc_out=proto --go-grpc_opt=paths=source_relative proto/pro.proto
...
const (
	DkronPro_ACLPolicyUpsert_FullMethodName = "/types.DkronPro/ACLPolicyUpsert"
	DkronPro_ACLPolicyDelete_FullMethodName = "/types.DkronPro/ACLPolicyDelete"
	DkronPro_ACLPolicyInfo_FullMethodName   = "/types.DkronPro/ACLPolicyInfo"
	DkronPro_ACLPolicyList_FullMethodName   = "/types.DkronPro/ACLPolicyList"
	DkronPro_ACLTokenUpsert_FullMethodName  = "/types.DkronPro/ACLTokenUpsert"
	DkronPro_ACLTokenDelete_FullMethodName  = "/types.DkronPro/ACLTokenDelete"
	DkronPro_ACLTokenInfo_FullMethodName    = "/types.DkronPro/ACLTokenInfo"
	DkronPro_ACLTokenList_FullMethodName    = "/types.DkronPro/ACLTokenList"
)
...
func RegisterDkronProServer(s grpc.ServiceRegistrar, srv DkronProServer) {
	// If the following call pancis, it indicates UnimplementedDkronProServer was
