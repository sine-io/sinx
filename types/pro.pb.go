...
const file_pro_proto_rawDesc = "" +
	"\n" +
	"\tpro.proto\x12\x05types\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"2\n" +
	"\x06Policy\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05rules\x18\x02 \x01(\tR\x05rules\"?\n" +
	"\x16ACLPolicyUpsertRequest\x12%\n" +
	"\x06policy\x18\x01 \x01(\v2\r.types.PolicyR\x06policy\"3\n" +
	...
	"\x06policy\x18\x01 \x01(\v2\r.types.PolicyR\x06policy\"B\n" +
	"\x15ACLPolicyListResponse\x12)\n" +
	"\bpolicies\x18\x01 \x03(\v2\r.types.PolicyR\bpolicies\"\x8b\x02\n" +
	"\x05Token\x12\x1a\n" +
	"\baccessor\x18\x01 \x01(\tR\baccessor\x12\x16\n" +
	"\x06secret\x18\x02 \x01(\tR\x06secret\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12$\n" +
	"\x04type\x18\x04 \x01(\x0e2\x10.types.TokenTypeR\x04type\x12;\n" +
	...
	"\x05token\x18\x01 \x01(\v2\f.types.TokenR\x05token\"2\n" +
	...
	"\x05token\x18\x01 \x01(\v2\f.types.TokenR\x05token\"<\n" +
	"\x14ACLTokenListResponse\x12$\n" +
	"\x06tokens\x18\x01 \x03(\v2\f.types.TokenR\x06tokens*'\n" +
	"\tTokenType\x12\x0e\n" +
	"\n" +
	"management\x10\x00\x12\n" +
	"\n" +
	"\x06client\x10\x012\xec\x04\n" +
	"\aSinxPro\x12P\n" +
	"\x0fACLPolicyUpsert\x12\x1d.types.ACLPolicyUpsertRequest\x1a\x1e.types.ACLPolicyUpsertResponse\x12P\n" +
	"\x0fACLPolicyDelete\x12\x1d.types.ACLPolicyDeleteRequest\x1a\x1e.types.ACLPolicyDeleteResponse\x12J\n" +
	"\rACLPolicyInfo\x12\x1b.types.ACLPolicyInfoRequest\x1a\x1c.types.ACLPolicyInfoResponse\x12E\n" +
	"\rACLPolicyList\x12\x16.google.protobuf.Empty\x1a\x1c.types.ACLPolicyListResponse\x12M\n" +
	"\x0eACLTokenUpsert\x12\x1c.types.ACLTokenUpsertRequest\x1a\x1d.types.ACLTokenUpsertResponse\x12M\n" +
	"\x0eACLTokenDelete\x12\x1c.types.ACLTokenDeleteRequest\x1a\x1d.types.ACLTokenDeleteResponse\x12G\n" +
	"\fACLTokenInfo\x12\x1a.types.ACLTokenInfoRequest\x1a\x1b.types.ACLTokenInfoResponse\x12C\n" +
	"\fACLTokenList\x12\x16.google.protobuf.Empty\x1a\x1b.types.ACLTokenListResponseB\x1fZ\x1dgithub.com/sine-io/sinx/typesb\x06proto3"

var (
	file_pro_proto_rawDescOnce sync.Once
	file_pro_proto_rawDescData []byte
)

func file_pro_proto_rawDescGZIP() []byte {
	file_pro_proto_rawDescOnce.Do(func() {
		file_pro_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pro_proto_rawDesc), len(file_pro_proto_rawDesc)))
	})
...
var file_pro_proto_goTypes = []any{
...
var file_pro_proto_depIdxs = []int32{
	...
	2,  // 9: types.SinxPro.ACLPolicyUpsert:input_type -> types.ACLPolicyUpsertRequest
	4,  // 10: types.SinxPro.ACLPolicyDelete:input_type -> types.ACLPolicyDeleteRequest
	6,  // 11: types.SinxPro.ACLPolicyInfo:input_type -> types.ACLPolicyInfoRequest
	18, // 12: types.SinxPro.ACLPolicyList:input_type -> google.protobuf.Empty
	10, // 13: types.SinxPro.ACLTokenUpsert:input_type -> types.ACLTokenUpsertRequest
	12, // 14: types.SinxPro.ACLTokenDelete:input_type -> types.ACLTokenDeleteRequest
	14, // 15: types.SinxPro.ACLTokenInfo:input_type -> types.ACLTokenInfoRequest
	18, // 16: types.SinxPro.ACLTokenList:input_type -> google.protobuf.Empty
	3,  // 17: types.SinxPro.ACLPolicyUpsert:output_type -> types.ACLPolicyUpsertResponse
	5,  // 18: types.SinxPro.ACLPolicyDelete:output_type -> types.ACLPolicyDeleteResponse
	7,  // 19: types.SinxPro.ACLPolicyInfo:output_type -> types.ACLPolicyInfoResponse
	8,  // 20: types.SinxPro.ACLPolicyList:output_type -> types.ACLPolicyListResponse
	11, // 21: types.SinxPro.ACLTokenUpsert:output_type -> types.ACLTokenUpsertResponse
	13, // 22: types.SinxPro.ACLTokenDelete:output_type -> types.ACLTokenDeleteResponse
	15, // 23: types.SinxPro.ACLTokenInfo:output_type -> types.ACLTokenInfoResponse
	16, // 24: types.SinxPro.ACLTokenList:output_type -> types.ACLTokenListResponse
...
func file_pro_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pro_proto_rawDesc), len(file_pro_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
